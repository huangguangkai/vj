...
const Bar = React.createClass({
  render() {
    return (
      <Navbar>
        <Nav>
          <NavItem href={`#/coo/banner?delete_status=${DELETE_STATUS.DEFAULT}`}>展示中</NavItem>
          <NavItem href={`#/coo/banner?delete_status=${DELETE_STATUS.DELETED}`}>已隐藏</NavItem>
        </Nav>
        <Navbar.Collapse>
          <Nav pullRight>
            <NavItem href="#/coo/banner/create">新增广告位</NavItem>
          </Nav>
        </Navbar.Collapse>
      </Navbar>
    )
